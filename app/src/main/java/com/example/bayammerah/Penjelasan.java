...
import com.example.bayammerah.API.Server;
import com.example.bayammerah.App.AppController;
...
public class Penjelasan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Penjelasan.this, ""+id, Toast.LENGTH_SHORT).show();
        ...
        iya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (y.equals("P")){
                    Intent intent = new Intent(Penjelasan.this, Solusi.class);
                    intent.putExtra("id",Y);
                    startActivity(intent);
                    finish();
                }
                else if(y.equals("G")){
                    Intent intent = new Intent(Penjelasan.this, Penjelasan.class);
                    intent.putExtra("id",Y);
                    startActivity(intent);
                    finish();
                }
        ...
        tidak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (t.equals("P")){
                    ...
                    Toast.makeText(Penjelasan.this, "Tidak SAkit kakak", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Penjelasan.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                }
